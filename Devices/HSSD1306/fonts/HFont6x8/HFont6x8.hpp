...
/**
 * @brief 6x8 font: Latin from the SSD1306xLED reference, Cyrillic to be drawn.
 *
 * One page tall, six columns per glyph, spacing included. Covers:
 *
 * | Block | Codepoints | State |
 * | --- | --- | --- |
 * | Latin | ' ' (0x20) .. 'z' (0x7A) | drawn |
...
/** @brief The shared 6x8 font. */
extern const HFont6x8 font6x8;
